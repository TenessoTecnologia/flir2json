...
extern "C"
{
    ...
    */
    ...
    /** @brief Gets the local thermal parameters for the line.
     *  @relatesalso    ACS_LocalThermalParameters
     */
    ACS_API ACS_LocalThermalParameters* ACS_MeasurementLine_getLocalThermalParameters(const ACS_MeasurementLine* line);
