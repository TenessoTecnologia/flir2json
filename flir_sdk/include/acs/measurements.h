 ...
 *  @relatesalso    ACS_Measurements
 */
ACS_API ACS_MeasurementPolyline* ACS_Measurements_addPolyline(ACS_Measurements* measurements, ACS_ListPoint* points, bool markerMin, bool markerMax);
 ...
 *  @relatesalso    ACS_Measurements
 */
ACS_API ACS_MeasurementPolyline* ACS_Measurements_findPolyline(ACS_Measurements* measurements, int id);
 ...
 *  @relatesalso    ACS_Measurements
 */
ACS_API ACS_MeasurementPolyline* ACS_Measurements_movePolyline(ACS_Measurements* measurements, int id, ACS_ListPoint* points);
 ...
 *  @relatesalso    ACS_ListMeasurementPolyline
 */
ACS_API ACS_MeasurementPolyline* ACS_ListMeasurementPolyline_item(ACS_ListMeasurementPolyline* list, size_t index);
