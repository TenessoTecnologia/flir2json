...
extern "C"
{
    ...
    */
    ...
    /** @brief Gets the local thermal parameters for the ellipse.
     *  @relatesalso    ACS_LocalThermalParameters
     */
    ACS_API ACS_LocalThermalParameters* ACS_MeasurementEllipse_getLocalThermalParameters(const ACS_MeasurementEllipse* ellipse);
